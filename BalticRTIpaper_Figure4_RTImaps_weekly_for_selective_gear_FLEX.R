#### first the baseline maps for gear that reduces plaice catches (FLEX)
library(lubridate)
library(maps)
library(mapdata)
library(mapplots)
...
## here the plaice catches are reduced by 75%
RTI_grid_PLE<-0.25*CPUE_grid_PLE/mean_CEL_PLE
